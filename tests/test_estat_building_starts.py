...
USE_CLASSES = [
    ...
    {"@id": "use", "CLASS": [
        {"@code": "total", "@name": "計"},
        {"@code": "res", "@name": "Ａ居住専用住宅"},
        {"@code": "semi", "@name": "Ｂ居住専用準住宅"},
        {"@code": "mixed", "@name": "Ｃ居住産業併用建築物"},
        {"@code": "info", "@name": "Ｈ情報通信業用建築物"},
        {"@code": "retail", "@name": "Ｊ卸売業，小売業用建築物"},
        {"@code": "finance", "@name": "Ｋ金融業，保険業用建築物"},
        {"@code": "estate", "@name": "Ｌ不動産業用建築物"},
        {"@code": "food", "@name": "Ｍ宿泊業，飲食サービス業用建築物"},
        {"@code": "education", "@name": "Ｎ教育，学習支援業用建築物"},
        {"@code": "medical", "@name": "Ｏ医療，福祉用建築物"},
    ]},
    {"@id": "area", "CLASS": [{"@code": AREA, "@name": "千代田区"}]},
    {"@id": "time", "CLASS": [
        {"@code": "2022", "@name": "2022年"},
